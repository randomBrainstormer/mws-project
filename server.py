#   GzipSimpleHTTPServer implementation, from: https://github.com/ksmith97/GzipSimpleHTTPServer/blob/master/GzipSimpleHTTPServer.py
#   with a modified Cache policy for the Stage3 frontend server.
